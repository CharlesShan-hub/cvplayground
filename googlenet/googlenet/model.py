'''
    Copied from https://github.com/pytorch/vision/blob/main/torchvision/models/googlenet.py
'''
...
def googlenet(*, weights: Optional[GoogLeNet_Weights] = None, progress: bool = True, **kwargs: Any) -> GoogLeNet:
    ...
    if "model_path" in kwargs:
        model_dir = kwargs.pop("model_path")
    else:
        model_dir = None
    ...
    if weights is not None:
        model.load_state_dict(weights.get_state_dict(progress=progress, check_hash=True, model_dir=model_dir))
